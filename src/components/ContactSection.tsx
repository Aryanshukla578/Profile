          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">aryan.shukla@example.com</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                {/* Social Media Icons */}
                <a href="#" className="h-10 w-10 rounded-full bg-secondary/80 flex items-center justify-center hover:bg-purple-default transition-colors">
